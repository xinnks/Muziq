        ...
        <div class="uk-container uk-container-center">
            ...
            <div class="uk-width-1-2@m uk-align-center">
                ...
                <div class="uk-padding uk-box-shadow-large">
                    ...
                    <form enctype="multipart/form-data" class="uk-form-stacked" role="form" method="POST" action="{{ route('add.song.post') }}">
                        ...
                        <div class="uk-margin">
                            <div uk-form-custom>
                                ...
                                <button class="uk-button uk-button-default{{ $errors->has('audio_file') ? ' uk-form-danger' : '' }}" type="button" tabindex="-1">Select Music File</button>
                            </div>
                        ...
                        <div class="uk-margin">
                            ...
                            <div uk-form-custom>
                                ...
                                <button class="uk-button uk-button-default{{ $errors->has('cover_art') ? ' uk-form-danger' : '' }}" type="button" tabindex="-1">Select</button>
                            </div>
