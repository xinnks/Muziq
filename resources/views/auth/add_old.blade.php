        ...
        <div class="uk-container uk-container-center">
            ...
            <div class="uk-width-1-2@m uk-align-center">
                ...
                <div class="uk-padding uk-box-shadow-large">
                    ...
                    <form class="uk-form-stacked" role="form" method="POST" action="http://127.0.0.1:8000/api/add_music_file">

                        <div class="uk-margin">
                            <div uk-form-custom>
                                <input type="file" ref="music_file" name="music_file" v-on:change="addFile()" accept="audio/*">
                                <button class="uk-button uk-button-default" type="button" tabindex="-1">Select Music File</button>
                                <progress :class="failed ? 'uk-progress failed' : 'uk-progress'" :value="progress" :max="100"></progress>
                            </div>
                        </div>

                    </form>

                    <form class="uk-form-stacked" role="form" method="POST" action="{{ route('add.song') }}">

                        {{ csrf_field() }}

                        <input type="hidden" name="audio_id" :value="resultingAudioId">
                        ...
                        <div class="uk-margin">
                            ...
                            <div uk-form-custom="target: > * > span:first-child">
                                <select type="email" class="uk-input{{ $errors->has('artist_id') ? ' uk-form-danger' : '' }}" name="artist" value="{{ old('artist_id') }}" >
